...
const PremierDestination = () => {
  return (
    <div className="grid md:grid-cols-2 bg-[#ECF4D3] w-full h-screen">
      <div className="flex flex-col justify-center items-center ">
        <img src={pic} alt="" className="p-20 m-0 " />
      </div>
      <div className="flex flex-col justify-start items-start h1font ml-5">
        <h1 className="mt-40 text-[2.625rem] w-[65%] font-medium">
          Your Premier Destination for All Green.
        </h1>
        <p className="text-gray-700 mt-2 w-[75%]">
        ...
        <div className="grid md:grid-cols-2 gap-2 h1font">
